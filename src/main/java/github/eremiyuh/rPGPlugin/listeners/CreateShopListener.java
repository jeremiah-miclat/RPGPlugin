...
public class CreateShopListener implements Listener {
    ...
    public void onSignChange(SignChangeEvent event) {
        ...
        Set<String> validCurrencies = Set.of("diamond", "emerald", "iron", "lapis", "gold", "enderpearl", "netherite", "copper","activitypoints");
        ...
        try {
            ...
            if (!validCurrencies.contains(itemBeingTraded)) {
                ...
                player.sendMessage("Currencies: diamond, emerald, iron, lapis, gold, enderpearl, netherite, copper, activitypoints");
                event.setCancelled(true);
                return;
            }
